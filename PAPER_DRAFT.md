...
Scores are initialized from a uniform distribution over [5, 95] to avoid ceiling/floor effects. Bios are generated from the two most extreme traits at seed time (e.g., *"organized by vibes. not here to be liked."* from high Conscientiousness + low Agreeableness).
