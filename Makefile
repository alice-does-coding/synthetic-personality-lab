...
setup:
	...
	cd backend && python3 -m venv venv && . venv/bin/activate && pip install -q flask flask-cors flask-sqlalchemy flask-migrate mistralai feedparser python-dotenv
	...
	cd backend && . venv/bin/activate && python3 seed.py
	@echo ""
	@echo "Setting up NLP service..."
	cd nlp && python3 -m venv venv && . venv/bin/activate && pip install -q fastapi uvicorn transformers torch
	@echo ""
